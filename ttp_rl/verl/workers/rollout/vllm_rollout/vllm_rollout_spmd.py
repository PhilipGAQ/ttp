...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        # 🔑 CRITICAL FIX: Make a copy of non_tensor_batch to preserve original data
        # This ensures that metadata like reward_model, extra_info are preserved through rollout
